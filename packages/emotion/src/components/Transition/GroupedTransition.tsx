...
import { useTransition } from '@rendar/core';
import { OqTransition } from './transitions';

interface GroupedTransitionItem {
  duration: number;
  timingFunction?: React.CSSProperties['transitionTimingFunction'];
  transition: OqTransition;
}
...
export function GroupedTransition({
  ...
  const transitionsStyles = Object.keys(transitions).reduce((acc: any, transition) => {
